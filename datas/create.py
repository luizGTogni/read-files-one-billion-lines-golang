...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    try:
        with open("datas/measurements.txt", 'w') as file:
            progress = 0
    ...
    file_size = os.path.getsize("datas/measurements.txt")
    human_file_size = convert_bytes(file_size)

    print("Test data successfully written to datas/measurements.txt")
